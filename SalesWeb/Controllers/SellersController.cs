...
namespace SalesWeb.Controllers {
    public class SellersController : Controller {
        ...
        public async Task<IActionResult> Delete(int? id) { // Isso é como se fosse um "get" delete.
            if (id == null) {
        ...
        public async Task<IActionResult> Edit(int? id) {
            ...
            List<Department> departments = await _departmentService.FindAllAsync(); // povoar o select box
